...
│   ├── Nivel 3: Grid interactivo (Cuadrícula con 3 actividades destacadas)
│   └── Nivel 3: Navbar de navegación (Enlaces directos a Actividades e Inscripción)
│
├── Nivel 2: Módulo 2. Catálogo de Actividades
│   ├── Nivel 3: Buscador de eventos (Barra de filtrado por palabras clave)
│   ├── Nivel 3: Tarjetas responsivas (Cards de Bootstrap con información resumida y cupos)
│   └── Nivel 3: Botones de interacción (Acción directa para "Ver detalle")
│
├── Nivel 2: Módulo 3. Detalle de Actividad
│   ├── Nivel 3: Bloque informativo extendido (Descripción, requisitos y cupo máximo)
│   └── Nivel 3: Botón dinámico de estado (Acción de Inscripción o Alerta de "Lista de espera" en JavaScript)
│
├── Nivel 2: Módulo 4. Formulario de Inscripción
│   ├── Nivel 3: Formulario de captura (Campos de texto para Nombre, ID, correo y teléfono)
│   ├── Nivel 3: Dropdown dinámico (Selector para las 6 categorías principales del festival)
│   └── Nivel 3: Validaciones lógicas (Alertas de JavaScript para impedir campos vacíos y validar correos)
│
├── Nivel 2: Módulo 5. Agenda del Festival
│   ├── Nivel 3: Tabla cronológica (Distribución estructurada por bloques de fecha y hora)
│   └── Nivel 3: Etiquetas de estado visual (Badges de Bootstrap para Disponible, Lleno o Cancelado)
│
├── Nivel 2: Módulo 6. Stands o Grupos
│   └── Nivel 3: Sección informativa fija (Mosaico de tarjetas con responsables y ubicación de clubes)
│
└── Nivel 2: Módulo 7. Contacto y FAQ
    ├── Nivel 3: Bloque informativo (Datos de contacto del comité organizador y soporte)
    ├── Nivel 3: Acordeón interactivo (Sección de Preguntas Frecuentes desplegables)
    └── Nivel 3: Formulario de consulta (Campos simulados para el envío de dudas)
...
│   ├── Nivel 3: Formulario de credenciales (Campos de entrada para Usuario y Contraseña)
│   └── Nivel 3: Validación de acceso (Control lógico para el ingreso seguro al Dashboard)
│
├── Nivel 2: Módulo 2. Gestión de Actividades (Dashboard Central)
│   ├── Nivel 3: Formulario de registro (Creación y almacenamiento de nuevos eventos con cupo y lugar)
│   └── Nivel 3: Panel de modificaciones (Botones operativos para Modificar, Editar o Eliminar actividades)
│
├── Nivel 2: Módulo 3. Control de Inscripciones y Cupos
│   ├── Nivel 3: Tabla de datos (Visualización detallada de estudiantes registrados con su ID y carrera)
│   ├── Nivel 3: Módulo de aprobación (Gestión y liberación manual de cupos para la Lista de Espera)
│   └── Nivel 3: Indicadores de métricas (Bloques superiores con totales de inscritos y espacios libres)
│
└── Nivel 2: Módulo 4. Mantenimiento de Stands
    ├── Nivel 3: Formulario de adición (Registro de nuevos clubes o grupos participantes)
    └── Nivel 3: Modificador de mapa (Asignación o reubicación física de los stands en el evento) a 